    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (flag2)
            {
                ...
                bool flag4 = this.DirectoryName.Length == 2;
                if (flag4)
                {
                    this.DirectoryName += "\\";
                }
        ...
        {
            ModuleDefMD moduleDefMD = ModuleDefMD.Load(this.textBox1.Text);
            Form1.InjectAntiTamper(moduleDefMD);
            ...
            string text2 = text + Path.GetFileNameWithoutExtension(this.textBox1.Text) + "_Tampered" + Path.GetExtension(this.textBox1.Text);
            moduleDefMD.Write(text2, new ModuleWriterOptions(moduleDefMD)
            {
